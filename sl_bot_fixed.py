...
# -*- coding: utf-8 -*-
"""
SL Telegram Bot - Python Version (Fixed)
...
class SLBot:
    ...
    async def get_materials_status(self, chat_id, context):
        ...
        try:
            ...
            msg = 'Текущее количество материалов:\n\n'
    ...
    def run(self):
        ...
        try:
            # ИСПРАВЛЕНО: используем run_polling() для версии 20+
...
def main():
    ...
    try:
        bot = SLBot()
        bot.run()  # ИСПРАВЛЕНО: убрал asyncio.run()
